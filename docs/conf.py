...
from docs.generate_dynamic_rst import suppress_function_headers, append_info_to_docstring, generate_dynamic_fields_rst, \
    trim_module_docstring
...
def setup(app):
    suppress_function_headers()
    app.connect('builder-inited', django_setup)
    app.connect("builder-inited", lambda app: generate_dynamic_fields_rst(app.srcdir))
    app.connect("autodoc-process-docstring", append_info_to_docstring)
    app.connect("autodoc-process-docstring", trim_module_docstring)
